 ...
 *   - @/lib/api       → Position
 *   - @/lib/paperTrade → PaperOrder, MarketSnapshot, INITIAL_BALANCE
 *   - @/lib/pricing   → vanillaCall, vanillaPut
 *   - @/lib/utils     → cn, fmtProb, fmtPremium
 */
...
function computeScenarioValue(
  ...
  for (const pos of positions) {
    ...
    if (scenarioP === undefined) {
      // No slider for this market — use current value with correct sign
